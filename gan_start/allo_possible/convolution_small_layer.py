...
def Convolution_layer_unoptimized():
    ...
    return s.build(target="vitis_hls", mode="sw_emu", project="convolution_ipkernel.prj")
...
def Convolution_layer_unoptimized_reuse():
    ...
    # s_conv.split("z",8)
    # s_conv.reorder("z.outer","k","z.inner")
...
def Convolution_layer_pipeline():
    # concrete_type, batch_size, channel_in, channel_out, height, width,kernel_height, kernel_width,height_out,widthout,stride = int32,16,3,128,258,258,4,4,128,128,2
    concrete_type, batch_size, channel_in, channel_out, height, width,height_after_padding, width_after_padding,kernel_height, kernel_width,height_out,widthout,stride,padding = float32,4,3,16,64,64,66,66,4,4,32,32,2,1
