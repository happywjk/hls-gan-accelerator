...
extern "C" {
  void top_block2(
    ...
    load_weights(weight_data, shared_weights, gan_block2::IN_CHANNELS, gan_block2::OUT_CHANNELS);
    load_bias(bias_data, shared_bias, gan_block2::OUT_CHANNELS);
    ...
    load_input(input_data, shared_input, 
               gan_block2::IN_CHANNELS, 
               gan_block2::INPUT_HEIGHT, 
               gan_block2::INPUT_WIDTH,
               gan_block2::OUTPUT_HEIGHT,
               gan_block2::OUTPUT_WIDTH,
               gan_block2::OUTPUT_PADDING,
               gan_block2::PADDING, 
               gan_block2::STRIDE);
