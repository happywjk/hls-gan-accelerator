...
extern "C" {
  void top_block0(
    ...
    // for (int i = 0; i < 1 && i < gan_block0::IN_CHANNELS; i++) {
    //   printf("[%d]: %.6f\n", i, input_data[i]);
    // }
    
    // Load all parameters once
    load_weights(weight_data, shared_weights, gan_block0::IN_CHANNELS, gan_block0::OUT_CHANNELS);
    load_bias(bias_data, shared_bias, gan_block0::OUT_CHANNELS);
    ...
    // for (int i = 0; i < 3 && i < gan_block0::OUT_CHANNELS; i++) {
    ...
    load_input(input_data, shared_input, 
               gan_block0::IN_CHANNELS, 
               gan_block0::INPUT_HEIGHT, 
               gan_block0::INPUT_WIDTH,
               gan_block0::OUTPUT_HEIGHT,
               gan_block0::OUTPUT_WIDTH,
               gan_block0::OUTPUT_PADDING,
               gan_block0::PADDING, 
               gan_block0::STRIDE);
    ...
    // for (int c = 0; c < 1 && c < gan_block0::OUT_CHANNELS; c++) {
    //   for (int h = 0; h < 4 && h < gan_block0::OUTPUT_HEIGHT; h++) {
    //     for (int w = 0; w < 4 && w < gan_block0::OUTPUT_WIDTH; w++) {
    ...
    // for (int c = 0; c < 2 && c < gan_block0::OUT_CHANNELS; c++) {
    //   for (int h = 0; h < 2 && h < gan_block0::OUTPUT_HEIGHT; h++) {
    //     for (int w = 0; w < 2 && w < gan_block0::OUTPUT_WIDTH; w++) {
    ...
    // for (int i = 0; i < 10 && i < (gan_block0::OUT_CHANNELS * gan_block0::OUTPUT_HEIGHT * gan_block0::OUTPUT_WIDTH); i++) {
