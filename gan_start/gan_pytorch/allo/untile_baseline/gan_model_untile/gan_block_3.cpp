...
extern "C" {
  void top_block3(
    ...
    load_weights(weight_data, shared_weights, gan_block3::IN_CHANNELS, gan_block3::OUT_CHANNELS);
    load_bias(bias_data, shared_bias, gan_block3::OUT_CHANNELS);
    ...
    load_input(input_data, shared_input, 
               gan_block3::IN_CHANNELS, 
               gan_block3::INPUT_HEIGHT, 
               gan_block3::INPUT_WIDTH,
               gan_block3::OUTPUT_HEIGHT,
               gan_block3::OUTPUT_WIDTH,
               gan_block3::OUTPUT_PADDING,
               gan_block3::PADDING, 
               gan_block3::STRIDE);
