...
// Weights for block 0 (net.0.0.weight)
...
// Weights for block 1 (net.1.0.weight)
...
for (unsigned i = 0; i < weight_size_1; i++) {
  ifile2 >> source_weights_1[i];
}
ifile2.close();

// Weights for block 2 (net.2.0.weight)
...
for (unsigned i = 0; i < weight_size_2; i++) {
  ifile3 >> source_weights_2[i];
}
ifile3.close();

// Weights for block 3 (net.3.0.weight)
...
for (unsigned i = 0; i < weight_size_3; i++) {
  ifile4 >> source_weights_3[i];
}
ifile4.close();

// Weights for block 4 (net.4.0.weight)
...
for (unsigned i = 0; i < weight_size_4; i++) {
  ifile5 >> source_weights_4[i];
}
ifile5.close();

// Weights for final layer (net.5.weight)
...
for (unsigned i = 0; i < weight_size_5; i++) {
  ifile6 >> source_weights_5[i];
}
ifile6.close();

// Biases for block 0 (net.0.0.bias)
...
for (unsigned i = 0; i < bias_size_0; i++) {
  ifile7 >> source_bias_0[i];
}
ifile7.close();

// Biases for block 1 (net.1.0.bias)
...
// Biases for block 2 (net.2.0.bias)
...
for (unsigned i = 0; i < bias_size_2; i++) {
  ifile9 >> source_bias_2[i];
}
ifile9.close();

// Biases for block 3 (net.3.0.bias)
...
for (unsigned i = 0; i < bias_size_3; i++) {
  ifile10 >> source_bias_3[i];
}
ifile10.close();

// Biases for block 4 (net.4.0.bias)
...
for (unsigned i = 0; i < bias_size_4; i++) {
  ifile11 >> source_bias_4[i];
}
ifile11.close();

// Biases for final layer (net.5.bias)
...
for (unsigned i = 0; i < bias_size_5; i++) {
  ifile12 >> source_bias_5[i];
}
ifile12.close();

// BatchNorm weights (gamma) for block 0 (net.0.1.weight)
...
for (unsigned i = 0; i < bias_size_0; i++) {
  ifile13 >> source_gamma_0[i];
}
ifile13.close();

// BatchNorm weights (gamma) for block 1 (net.1.1.weight)
...
for (unsigned i = 0; i < bias_size_1; i++) {
  ifile14 >> source_gamma_1[i];
}
ifile14.close();

// BatchNorm weights (gamma) for block 2 (net.2.1.weight)
...
// BatchNorm weights (gamma) for block 3 (net.3.1.weight)
...
for (unsigned i = 0; i < bias_size_3; i++) {
  ifile16 >> source_gamma_3[i];
}
ifile16.close();

// BatchNorm weights (gamma) for block 4 (net.4.1.weight)
...
for (unsigned i = 0; i < bias_size_4; i++) {
  ifile17 >> source_gamma_4[i];
}
ifile17.close();

// BatchNorm biases (beta) for block 0 (net.0.1.bias)
...
for (unsigned i = 0; i < bias_size_0; i++) {
  ifile18 >> source_beta_0[i];
}
ifile18.close();

// BatchNorm biases (beta) for block 1 (net.1.1.bias)
...
for (unsigned i = 0; i < bias_size_1; i++) {
  ifile19 >> source_beta_1[i];
}
ifile19.close();

// BatchNorm biases (beta) for block 2 (net.2.1.bias)
...
for (unsigned i = 0; i < bias_size_2; i++) {
  ifile20 >> source_beta_2[i];
}
ifile20.close();

// BatchNorm biases (beta) for block 3 (net.3.1.bias)
...
for (unsigned i = 0; i < bias_size_3; i++) {
  ifile21 >> source_beta_3[i];
}
ifile21.close();

// BatchNorm biases (beta) for block 4 (net.4.1.bias)
...
for (unsigned i = 0; i < bias_size_4; i++) {
  ifile22 >> source_beta_4[i];
}
ifile22.close();

// BatchNorm running mean for block 0 (net.0.1.running_mean)
...
for (unsigned i = 0; i < bias_size_0; i++) {
  ifile23 >> source_mean_0[i];
}
ifile23.close();

// BatchNorm running mean for block 1 (net.1.1.running_mean)
...
for (unsigned i = 0; i < bias_size_1; i++) {
  ifile24 >> source_mean_1[i];
}
ifile24.close();

// BatchNorm running mean for block 2 (net.2.1.running_mean)
...
for (unsigned i = 0; i < bias_size_2; i++) {
  ifile25 >> source_mean_2[i];
}
ifile25.close();

// BatchNorm running mean for block 3 (net.3.1.running_mean)
...
for (unsigned i = 0; i < bias_size_3; i++) {
  ifile26 >> source_mean_3[i];
}
ifile26.close();

// BatchNorm running mean for block 4 (net.4.1.running_mean)
...
for (unsigned i = 0; i < bias_size_4; i++) {
  ifile27 >> source_mean_4[i];
}
ifile27.close();

// BatchNorm running variance for block 0 (net.0.1.running_var)
...
for (unsigned i = 0; i < bias_size_0; i++) {
  ifile28 >> source_var_0[i];
}
ifile28.close();

// BatchNorm running variance for block 1 (net.1.1.running_var)
...
for (unsigned i = 0; i < bias_size_1; i++) {
  ifile29 >> source_var_1[i];
}
ifile29.close();

// BatchNorm running variance for block 2 (net.2.1.running_var)
...
for (unsigned i = 0; i < bias_size_2; i++) {
  ifile30 >> source_var_2[i];
}
ifile30.close();

// BatchNorm running variance for block 3 (net.3.1.running_var)
...
for (unsigned i = 0; i < bias_size_3; i++) {
  ifile31 >> source_var_3[i];
}
ifile31.close();

// BatchNorm running variance for block 4 (net.4.1.running_var)
...
uint64_t write_start, write_end, kernel_start, kernel_end, read_start, read_end;

// Data move in (host to device)
OCL_CHECK(err, err = q.enqueueMigrateMemObjects(inBufVec, 0 /* 0 means from host*/, nullptr, &write_event));

// Launch the Kernel
OCL_CHECK(err, err = q.enqueueTask(krnl_top, nullptr, &kernel_event));

// Copy Result from Device Global Memory to Host Local Memory
OCL_CHECK(err, err = q.enqueueMigrateMemObjects({buffer_output}, CL_MIGRATE_MEM_OBJECT_HOST, nullptr, &read_event));
q.finish();

// Get the execution times
// Data move in time
OCL_CHECK(err, err = write_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_START, &write_start));
OCL_CHECK(err, err = write_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_END, &write_end));
auto data_in_time = write_end - write_start;

// Kernel execution time
OCL_CHECK(err, err = kernel_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_START, &kernel_start));
OCL_CHECK(err, err = kernel_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_END, &kernel_end));
auto kernel_time = kernel_end - kernel_start;

// Data move out time
OCL_CHECK(err, err = read_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_START, &read_start));
OCL_CHECK(err, err = read_event.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_END, &read_end));
auto data_out_time = read_end - read_start;

// Calculate total time
auto total_time = data_in_time + kernel_time + data_out_time;

// Print timing breakdown
std::cout << "|-------------------+-------------------------|\n";
std::cout << "| Operation         |    Wall-Clock Time (ns) |\n";
std::cout << "|-------------------+-------------------------|\n";
std::cout << "| " << std::left << std::setw(18) << "Data Transfer In" << "|" 
          << std::right << std::setw(24) << data_in_time << " |\n";
std::cout << "| " << std::left << std::setw(18) << "Kernel Execution" << "|" 
          << std::right << std::setw(24) << kernel_time << " |\n";
std::cout << "| " << std::left << std::setw(18) << "Data Transfer Out" << "|" 
          << std::right << std::setw(24) << data_out_time << " |\n";
std::cout << "|-------------------+-------------------------|\n";
std::cout << "| " << std::left << std::setw(18) << "Total Time" << "|" 
          << std::right << std::setw(24) << total_time << " |\n";
std::cout << "|-------------------+-------------------------|\n";
